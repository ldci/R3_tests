...
vec3: minMaxNormalization vec2					;--normalize detrended signal
generateImage vec1 bm1 0.4 navy				;--original signal
generateImage vec2 bm2 0.5 red					;--detrended signal
generateImage vec3 bm3 25.0 green				;--normalized signal
print vec1 = vec2
print vec2 = vec3
if opencv? [
	cv/imshow/name :bm1 "Random Signal"
	cv/imshow/name :bm2 "Detrended Signal"
	cv/imshow/name :bm3 "Min-Max Normalized Signal"
	cv/moveWindow "Detrended Signal" 0x80
	cv/moveWindow "Min-Max Normalized Signal" 0x210
