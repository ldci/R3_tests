...
REBOL [
	...
	Author: "LDCI"
	Version: 4.0
	Notes: {This code allows to visualize basic UFT-8 and UFT-16 unicode characters}
]
...
getCodes: func [
	...
	if starting = 0 [starting: starting + 1]
	...
	if n > 3 [
		...
		clear label
		while [i <= n][
			append  label  rejoin [ss/:i " "] i: i + 1] 
	]
	i: starting
	while [i <= ending] [
