...
v1: #(i32! [1 4 6 12 12 11 16 9 5 4 3 2 5])	;--sample 1
v2: #(i32! [1 3 4 4 11 13 10 10 9 5 5 10])	;--sample 2
v3: #(i32! [1 4 6 12 12 11 16 9 5 4 3 2 5 1 3 4 4 11 13 10 10 9 5 5 10]);--population

;--Makes contingence table
data: []
median: v3/median ;--population median
...
print ""
print ["Median test =" round/to k2 0.001 as-yellow "Non Significant"]